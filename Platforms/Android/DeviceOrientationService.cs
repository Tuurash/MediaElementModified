...
{
	private static readonly IReadOnlyDictionary<DisplayOrientation, 
		ScreenOrientation> _androidDisplayOrientationMap =
	...
	public partial void SetDeviceOrientation(DisplayOrientation displayOrientation)
	{
		...
		if (currentActivity is not null 
			&& _androidDisplayOrientationMap.TryGetValue(displayOrientation,
			out ScreenOrientation screenOrientation)) 
